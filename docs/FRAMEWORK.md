...
> GitHub 그림 요약: **[FLOWCHART.md](./FLOWCHART.md)**

> **범위:** 앱만 (랜딩·사전예약 웹은 별도)  
> **기준:** 제품 오너 인터뷰로 확정한 **목표 프레임워크** (기존 MVP 코드와 다를 수 있음)  
> **목적:** GitHub의 이 문서만 보고 화면·규칙·데이터·API·운영 화면을 구현할 수 있게 함  
> **제외(이번 문서):** 와이어프레임·시각 디자인 (프레임워크 확정 후 별도)
